% \begin{figure}[h!]
% 	\centering
% \subfloat[\label{fig:fig:RegionsOutline}]{}
% \subfloat[\label{fig:Environment_directed}]{
...
% \end{tikzpicture}}
% \caption{The connectivity graph $G_\design$ of the UAM hub controllers $\design$ modeling the sectors $V$ in  Figure~\ref{fig:RegionsOutline}. 
