...
\filldraw[fill=gray!80!white,draw=black] (-1.0,-0.5) rectangle (-1.5,-0.0);
\filldraw[fill=gray!80!white,draw=black] (-0.5,-1) rectangle (-1,-0.5);
\filldraw[fill=gray!80!white,draw=black] (-0.5,-1.5) rectangle (-1,-1);
\filldraw[fill=gray!80!white,draw=black] (-1.0,-1) rectangle (-1.5,-0.5);
\filldraw[fill=gray!80!white,draw=black] (-1.0,-1.5) rectangle (-1.5,-1);
