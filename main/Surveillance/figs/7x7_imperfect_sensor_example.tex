...
\filldraw[fill=gray!80!white,draw=black] (-1.0,0.5) rectangle (-0.5,0.0);
\filldraw[fill=gray!80!white,draw=black] (-1.0,1.0) rectangle (-0.5,0.5);
\filldraw[fill=gray!80!white,draw=black] (-0.5,0.5) rectangle (0.0,0.0);
\filldraw[fill=gray!80!white,draw=black] (-0.5,1.0) rectangle (0.0,0.5);
\filldraw[fill=gray!80!white,draw=black] (0.0,0.5) rectangle (0.5,0.0);
\filldraw[fill=gray!80!white,draw=black] (0.0,1.0) rectangle (0.5,0.5);
