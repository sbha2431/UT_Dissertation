...
%\hfill
\caption{A simple surveillance game on a grid arena. The agent is shown in blue, the target in orange, and obstacles in red. Grey locations depict the current observation the agent receives as output from the sensors.}
...
\subsubsection*{\textbf{Remark}}\label{sec:sensefunction}
